...
class SearchingInfoEmailOfResidentsByCityImplTest {
	...
	void testSearchInfoOfResident() throws Exception {
		...
		try {
			List<Map<String, String>> listOfResidentsFoundByCity =  infoOfResidentsByCityUnderTest
			...
			assertThat(listOfResidentsFoundByCity).filteredOn("email",personTest.getEmail());
